    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telefone', models.CharField(blank=True, max_length=20, null=True, validators=[customers.validators.validate_phone])),
                ('data_cad', models.DateTimeField(auto_now_add=True)),
                ('documento', models.CharField(max_length=14, validators=[customers.validators.validate_document])),
                ('tipo_pessoa', models.CharField(choices=[('fisica', 'Física'), ('juridica', 'Jurídica')], max_length=255)),
                ...
                ('estado_civil', models.CharField(blank=True, choices=[('solteiro', 'Solteiro(a)'), ('casado', 'Casado(a)'), ('divorciado', 'Divorciado(a)'), ('viuvo', 'Viúvo(a)'), ('separado judicialmente', 'Separado(a) Judicialmente'), ('uniao estavel', 'União Estável')], max_length=255, null=True)),
            ],
            options={
